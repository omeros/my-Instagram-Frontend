      ...
      <div class="nav-bar main-header-inner">
            ...
            <nav>
              ...
              <div class="header-links">
                ...
                <router-link to="/login" class="hart opacity" > 
                ...
                <router-link v-if="loggedInUser.imgUrl" :to="`/user/${loggedInUser._id}`"><img  class="user-logo opacity"  :src="loggedInUser.imgUrl"  alt="profile pic" /></router-link>
                <router-link v-else :to="`/login`" ><img  class="user-logo " src="http://coding-academy.org/books-photos/11.jpg" alt="profile pic"/></router-link>
                <!-- <router-link to="/login" class="login-router-link"  >Login / Signup</router-link > -->
              </div>
            </nav>
      </div>
